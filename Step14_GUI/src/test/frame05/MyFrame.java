...
import javax.swing.JOptionPane;
	...
	public class MyFrame extends JFrame implements ActionListener{ //ActionListener 인터페이스 구현
		...
		public MyFrame() {
			...
			JButton sendBtn=new JButton("전송");	//필드로 
			JButton updateBtn=new JButton("삭제");
			JButton deleteBtn=new JButton("수정");
			...
			JFrame b= this;
			MyFrame c=this;
			ActionListener d = this; //MyFrame 클래스가 직접 구현함
			
			sendBtn.addActionListener(d);
